...
public class CustomerID implements objID {
	...
	public String getID() {
		...
		try {
			...
			String selectSQl = "select code from id_code where description = 'CUSTOMER'";
			...
			if (isEmpty == true) {
				...
				prepareStatement = conn
						.prepareStatement("select next value for customer_id_seq");
